	...
	<h1>
		...
		<main class="main-wrap">
			<div class="search">
				...
				<form class="search__form" method="get" action="/IPLocation_war_exploded/GetLocationServlet" onsubmit="return checkIP()" >
					<input id="search-input" class="search__input" name="ip" type="search" placeholder="" autocomplete="off" autocorrect="off" autocapitalize="off" spellcheck="false" />
...
<%--				<h1 class="codrops-header__title">Inpiration for Search UI Effects</h1>--%>
				<div class="codrops-header__side">
					<nav class="codrops-demos">
						<span>Back Home </span>
						<a class="current-demo" href="index.jsp">go</a>
	...
	<script>
		...
		function checkIP() {
			var ip = document.getElementById('search-input').value;
